...
# Veriyi oku
try:
    df = pd.read_excel('/Users/haticeguler/Desktop/IntentClassification/Egitim-3972-2.xlsx')
...
df.to_excel('/Users/haticeguler/Desktop/IntentClassification/Egitim-3972-2.xlsx', index=False)
